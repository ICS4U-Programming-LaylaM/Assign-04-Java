...
/**
* This program calculates and displays a right triangle's, name, perimeter,
...
public class RightTriangle extends Triangle {
    ...
    */
    public void getName() {
        // Checks if the right triangle is isosceles
        if (_side1 == _side2 || _side2 == _side3 || _side3 == _side1) {
            final String rightAngleStr = "This is an isosceles "
                + "right angle triangle.";

            System.out.println(rightAngleStr + newLine);

            try {
                // Build a string containing that string
                final StringBuilder builder = new StringBuilder();
                builder.append(rightAngleStr);
        ...
        // Otherwise the right triangle is scalene
        } else {
            final String rightAngleStr = "This is a scalene right"
                + " angle triangle.";
