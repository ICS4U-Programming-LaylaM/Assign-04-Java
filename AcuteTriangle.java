...
/**
* This program calculates and displays the triangles name, perimeter, area,
* and angles to the console and to a text file.
*
* @author Layla Michel
* @version 1.0
* @since 2022-05-31
...
public class AcuteTriangle extends Triangle {
    ...
    */
    public AcuteTriangle(double side1, double side2, double side3) {
    ...
    */
    public void getName() {
        // Checks if the acute triangle is equilateral
        if (_side1 == _side2 && _side1 == _side3) {
            final String acuteAngleStr = "This is an equilateral acute "
                + "angle triangle.";

            System.out.println(acuteAngleStr + newLine);

            try {
                // Build a string containing that string
                final StringBuilder builder = new StringBuilder();
                builder.append(acuteAngleStr);
        ...
        // Checks if the acute triangle is isosceles
        } else if (_side1 == _side2 || _side2 == _side3
                    || _side3 == _side1) {
            final String acuteAngleStr = "This is an isosceles acute"
                + " angle triangle.";
        ...
        // Otherwise the acute triangle is scalene
        } else {
            final String acuteAngleStr = "This is a scalene "
